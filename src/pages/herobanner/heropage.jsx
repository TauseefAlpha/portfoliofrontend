        ...
        <div className="container ">
          <div className="row">
            <div className="col-sm-6">
              ...
              <h1 className="text-light  heading" ref={(el) => (heading = el)}>
                Hello<br></br>
                I'm Tauseef
                <br /> Ahmad
              </h1>
              <p className="content" ref={(el) => (paragraph = el)}>
                I Am a Mern Stack Developer with a vast array of knowledge in
                frontend and backend end languages responsive website, built
                websites using technologie like Reactjs,bookstrap, CSS,Material
                UI,TailwindCSS, MongoDB
              </p>
            ...
            <div
              ...
              className="col-sm-6   text-center mx-auto p-2 d-flex justify-content-center align-content-center imagclass"
            >
              <div className="circle">
                <div className="smallcircle left1  " ref={(el) => (left1 = el)}>
                  <h3>RJ</h3>
                </div>
                <div className="smallcircle left2  " ref={(el) => (left2 = el)}>
                  <h3>Js</h3>
                </div>
                <div
                  className="smallcircle Right1 "
                  ref={(el) => (right1 = el)}
                >
                  <h3>Css</h3>
                </div>
                <div
                  className="smallcircle right3  "
                  ref={(el) => (right2 = el)}
                >
                  <h3>Html</h3>
                </div>
