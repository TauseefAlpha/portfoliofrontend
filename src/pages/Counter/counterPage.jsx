          ...
          <div className="row px-5 ">
            <div className="col-md-3 px-0 experiencecount1">
              <div className="countdiv">
                <h2 className="text-center counststyle">
                  {counterOn && <CountUp start={0} duration={5} end={30} />}
                </h2>
                <div>
            ...
            <div className="col-md-3 px-0">
              <div className="countdiv">
                <h2 className=" text-center counststyle">
                  {counterOn && <CountUp start={0} duration={6} end={20} />}
                </h2>
            ...
            <div className="col-md-3 px-0 ">
              <div className="countdiv">
                <h2 className="text-center counststyle">
                  {counterOn && <CountUp start={0} duration={5} end={10} />}
                </h2>
                <div className="card-body">
            ...
            <div className="col-md-3 px-0 experiencecount">
              ...
              <div className="countdiv">
                <h2 className="text-center counststyle">
                  {counterOn && <CountUp start={0} duration={8} end={1} />}
                </h2>
                <div className="card-body">
